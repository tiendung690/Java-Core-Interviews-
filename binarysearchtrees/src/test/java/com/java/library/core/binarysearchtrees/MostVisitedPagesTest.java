...
public class MostVisitedPagesTest {
	...
	public void findMostVisited1() throws Exception {
		...
		pages = Arrays.asList(2, 3, 6, 4, 2, 6, 4, 3, 7, 8, 5, 4, 3, 2, 1, 5, 6, 4, 3, 2, 3, 4, 7, 6, 4);
		k = 1;
	...
	public void findMostVisited2() throws Exception {
		...
		pages = Arrays.asList(2, 3, 6, 4, 2, 6, 4, 3, 7, 8, 5, 4, 3, 2, 1, 5, 6, 4, 3, 2, 3, 4, 7, 6, 2);
		k = 3;
	...
	public void findMostVisited3() throws Exception {
		expected = Arrays.asList(2, 3, 4, 6, 7);
		pages = Arrays.asList(2, 3, 6, 4, 2, 6, 4, 3, 7, 8, 5, 4, 3, 2, 1, 5, 6, 4, 3, 2, 3, 4, 7, 6, 2);
		k = 5;
