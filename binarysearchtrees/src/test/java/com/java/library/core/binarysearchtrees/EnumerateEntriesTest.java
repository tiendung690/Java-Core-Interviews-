...
public class EnumerateEntriesTest {
	...
	public void generateFirst1() throws Exception {
		expected = Arrays.asList(new EnumerateEntries.ABSqrt2(0, 0), new EnumerateEntries.ABSqrt2(1, 0),
	...
	public void generateFirst2() throws Exception {
		expected = Arrays.asList(new EnumerateEntries.ABSqrt2(0, 0), new EnumerateEntries.ABSqrt2(1, 0),
				new EnumerateEntries.ABSqrt2(0, 1), new EnumerateEntries.ABSqrt2(2, 0),
	...
	public void generateFirst3() throws Exception {
		expected = Arrays.asList(new EnumerateEntries.ABSqrt2(0, 0), new EnumerateEntries.ABSqrt2(1, 0),
				new EnumerateEntries.ABSqrt2(0, 1), new EnumerateEntries.ABSqrt2(2, 0),
				new EnumerateEntries.ABSqrt2(1, 1), new EnumerateEntries.ABSqrt2(0, 2),
				new EnumerateEntries.ABSqrt2(3, 0), new EnumerateEntries.ABSqrt2(2, 1),
				new EnumerateEntries.ABSqrt2(1, 2), new EnumerateEntries.ABSqrt2(4, 0));
		k = 10;
