...
public class GeneratePalindromicDecompositionsTest {
	...
	public void palindromicPartitioning1() throws Exception {
		expected = Arrays.asList(Arrays.asList("6", "1", "1", "1", "1", "6"), Arrays.asList("6", "11", "1", "1", "6"),
				Arrays.asList("6", "1", "1", "11", "6"), Arrays.asList("6", "11", "11", "6"),
	...
	public void palindromicPartitioning2() throws Exception {
		expected = Arrays.asList(Arrays.asList("0", "2", "0", "4", "4", "5", "1", "8", "8", "1"),
				...
				Arrays.asList("020", "4", "4", "5", "1", "88", "1"), Arrays.asList("020", "4", "4", "5", "1881"),
				Arrays.asList("020", "44", "5", "1", "88", "1"), Arrays.asList("020", "44", "5", "1881"));
		input = "0204451881";
