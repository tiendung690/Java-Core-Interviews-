...
public class GenerateBinaryTreesTest {
	...
	public void generateAllBinaryTrees1() throws Exception {
		expected = Arrays.asList(new BinaryTree<>(0));
		numNodes = 1;
	...
	public void generateAllBinaryTrees2() throws Exception {
		expected = Arrays.asList(new BinaryTree<>(0, null, new BinaryTree<>(0)),
	...
	public void generateAllBinaryTrees3() throws Exception {
		expected = Arrays.asList(new BinaryTree<>(0, null, new BinaryTree<>(0, new BinaryTree<>(0), null)),
