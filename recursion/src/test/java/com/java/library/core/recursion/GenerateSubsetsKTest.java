...
public class GenerateSubsetsKTest {
	...
	public void combinations1() throws Exception {
		expected = Arrays.asList(Arrays.asList(1, 2), Arrays.asList(1, 3), Arrays.asList(2, 3));
		n = 3;
		k = 2;
	...
	public void combinations2() throws Exception {
		expected = Arrays.asList(Arrays.asList(1, 2, 3), Arrays.asList(1, 2, 4), Arrays.asList(1, 3, 4),
				Arrays.asList(2, 3, 4));
		n = 4;
		k = 3;
	...
	public void combinations3() throws Exception {
		expected = Arrays.asList(Arrays.asList(1, 2), Arrays.asList(1, 3), Arrays.asList(1, 4), Arrays.asList(1, 5),
				Arrays.asList(2, 3), Arrays.asList(2, 4), Arrays.asList(2, 5), Arrays.asList(3, 4), Arrays.asList(3, 5),
				Arrays.asList(4, 5));
		n = 5;
		k = 2;
