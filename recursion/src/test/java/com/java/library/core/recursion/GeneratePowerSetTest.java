...
public class GeneratePowerSetTest {
	...
	public void generatePowerSet1() throws Exception {
		expected = Arrays.asList(Arrays.asList(-1), Arrays.asList(0));
		A = Arrays.asList(0);
	...
	public void generatePowerSet2() throws Exception {
		expected = Arrays.asList(Arrays.asList(-1), Arrays.asList(0), Arrays.asList(1), Arrays.asList(0, 1));
		A = Arrays.asList(0, 1);
	...
	public void generatePowerSet3() throws Exception {
		expected = Arrays.asList(Arrays.asList(-1), Arrays.asList(0), Arrays.asList(1), Arrays.asList(2),
				Arrays.asList(0, 1), Arrays.asList(0, 2), Arrays.asList(1, 2), Arrays.asList(0, 1, 2)
