...
public class ComputeExteriorTest {
	...
	public void exteriorBinaryTree1() throws Exception {
		...
		expected = new LinkedList<>(Arrays.asList(tree, tree.left, tree.right));
	...
	public void exteriorBinaryTree2() throws Exception {
		...
		expected = new LinkedList<>(
				Arrays.asList(tree, tree.left, tree.left.right, tree.right.left, tree.right.right, tree.right));
	...
	public void exteriorBinaryTree3() throws Exception {
		...
		expected = new LinkedList<>(Arrays.asList(tree, tree.left, tree.left.left, tree.left.left.left,
				tree.left.left.right, tree.left.right.right.left, tree.right.left.right.left.right,
				tree.right.left.right.right, tree.right.right.right, tree.right.right, tree.right));
