...
public class ComputeLowestCommonAncestor {
	...
	public static BinaryTree<Integer> LCA(BinaryTree<Integer> tree, BinaryTree<Integer> node0,
	...
	private static Stack<BinaryTree<Integer>> dfs(BinaryTree<Integer> tree, BinaryTree<Integer> node,
			Stack<BinaryTree<Integer>> stack) {
		if (tree == null)
			return stack;
		stack.push(tree);
