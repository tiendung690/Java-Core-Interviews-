...
public class MinimumWeightPathTriangleTest {
	...
	public void minimum1() throws Exception {
		expected = 15;
		triangle = Arrays.asList(Arrays.asList(2), Arrays.asList(4, 4), Arrays.asList(8, 5, 6),
				Arrays.asList(4, 2, 6, 2), Arrays.asList(1, 5, 2, 3, 4));
	...
	public void minimum2() throws Exception {
		expected = 20;
		triangle = Arrays.asList(Arrays.asList(2), Arrays.asList(4, 4), Arrays.asList(8, 5, 6),
				Arrays.asList(4, 2, 6, 2), Arrays.asList(1, 5, 2, 3, 4), Arrays.asList(1, 20, 20, 20, 20));
