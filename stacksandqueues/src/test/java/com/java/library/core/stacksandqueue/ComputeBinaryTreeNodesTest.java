...
public class ComputeBinaryTreeNodesTest {
	...
	public void binaryTreeDepthOrder1() {
		expected = Arrays.asList(Arrays.asList(314), Arrays.asList(6, 6), Arrays.asList(271, 561, 2, 271),
				Arrays.asList(28, 0, 3, 1, 28), Arrays.asList(17, 401, 257), Arrays.asList(641));
