...
public class RenderCalendarTest {
	...
	public void findEvents1() throws Exception {
		expected = 0;
		A = Arrays.asList(new Tuple(0, 1), new Tuple(1, 2), new Tuple(2, 10));
	...
	public void findEvents2() throws Exception {
		expected = 3;
		A = Arrays.asList(new Tuple(0, 10), new Tuple(1, 5), new Tuple(2, 10));
	...
	public void findEvents3() throws Exception {
		expected = 3;
		A = Arrays.asList(new Tuple(1, 5), new Tuple(2, 7), new Tuple(4, 5), new Tuple(6, 10), new Tuple(8, 9),
				new Tuple(9, 17), new Tuple(11, 13), new Tuple(12, 15), new Tuple(14, 15));
