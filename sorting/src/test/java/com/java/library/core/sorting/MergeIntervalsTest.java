...
public class MergeIntervalsTest {
	...
	public void addInterval1() throws Exception {
		expected = Arrays.asList(new Tuple(-4, -1), new Tuple(0, 9), new Tuple(11, 12), new Tuple(14, 17));
		disjoint = Arrays.asList(new Tuple(-4, -1), new Tuple(0, 2), new Tuple(3, 6), new Tuple(7, 9),
				new Tuple(11, 12), new Tuple(14, 17));
	...
	public void addInterval2() throws Exception {
		expected = Arrays.asList(new Tuple(-6, -1), new Tuple(0, 2), new Tuple(3, 6), new Tuple(7, 9),
				new Tuple(11, 12), new Tuple(14, 17));
		disjoint = Arrays.asList(new Tuple(-4, -1), new Tuple(0, 2), new Tuple(3, 6), new Tuple(7, 9),
				new Tuple(11, 12), new Tuple(14, 17));
	...
	public void addInterval3() throws Exception {
		expected = Arrays.asList(new Tuple(-4, -1), new Tuple(0, 2), new Tuple(3, 6), new Tuple(7, 10),
				new Tuple(11, 12), new Tuple(14, 17));
		disjoint = Arrays.asList(new Tuple(-4, -1), new Tuple(0, 2), new Tuple(3, 6), new Tuple(7, 9),
				new Tuple(11, 12), new Tuple(14, 17));
