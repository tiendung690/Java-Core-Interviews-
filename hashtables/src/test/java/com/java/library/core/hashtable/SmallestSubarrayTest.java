...
public class SmallestSubarrayTest {
	...
	public void findSubarray1() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Daisy", "Garth", "Joan", "Daisy",
				"Joan", "Marcus");
		keywords = new HashSet<>(Arrays.asList("Mark", "Marcus"));
	...
	public void findSubarray2() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Mark", "Garth", "Joan", "Daisy",
				"Joan", "Marcus");
		keywords = new HashSet<>(Arrays.asList("Jordan", "Mark", "Garth"));
	...
	public void findSubarray3() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Joan", "Steven", "Greg", "Jordan", "Mark", "Kevin", "Joan", "Daisy",
				"Greg", "Mark");
		keywords = new HashSet<>(Arrays.asList("Mark", "Joan", "Greg"));
