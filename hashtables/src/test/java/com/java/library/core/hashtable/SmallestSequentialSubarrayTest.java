...
public class SmallestSequentialSubarrayTest {
	...
	public void findSubarray1() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Daisy", "Garth", "Marcus",
				"Daisy", "Joan", "Mark");
		keywords = new LinkedHashSet<>(Arrays.asList("Mark", "Marcus"));
	...
	public void findSubarray2() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Garth", "Mark", "Jordan",
				"Garth", "Joan", "Marcus");
		keywords = new LinkedHashSet<>(Arrays.asList("Jordan", "Mark", "Garth"));
	...
	public void findSubarray3() throws Exception {
		...
		paragraph = Arrays.asList("Mark", "Steve", "Joan", "Steven", "Greg", "Jordan", "Mark", "Kevin", "Joan", "Daisy",
				"Greg", "Mark");
		keywords = new LinkedHashSet<>(Arrays.asList("Steven", "Greg", "Jordan", "Mark", "Kevin"));
