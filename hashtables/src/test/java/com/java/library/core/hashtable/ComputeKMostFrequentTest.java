...
public class ComputeKMostFrequentTest {
	...
	public void mostFrequent1() throws Exception {
		expected = Arrays.asList("Joan");
		list = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Mark", "Garth", "Joan", "Daisy",
				"Joan", "Marcus");
		k = 1;
	...
	public void mostFrequent2() throws Exception {
		expected = Arrays.asList("Mark", "Joan");
		list = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Mark", "Garth", "Joan", "Daisy",
				"Joan", "Marcus");
		k = 2;
	...
	public void mostFrequent3() throws Exception {
		expected = Arrays.asList("Mark", "Joan", "Greg");
		list = Arrays.asList("Mark", "Steve", "Mason", "Joan", "Jordan", "Greg", "Mark", "Garth", "Joan", "Daisy",
				"Greg", "Marcus");
		k = 3;
