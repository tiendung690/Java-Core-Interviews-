...
import com.java.library.core.datastructures.Vertex;
...
public class ComputeShortestPathTest {
	...
	public void compute1() throws Exception {
		cost = 1;
		expected = Arrays.asList(graph.get(0), graph.get(2), graph.get(4), graph.get(3), graph.get(7));
		s = graph.get(0);
		t = graph.get(7);
	...
	public void setup() {
		...
		graph = Arrays.asList(a, b, c, d, e, f, g, h, i, j, k, l, m, n);
	}
